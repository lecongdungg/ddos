...
print("        .----. Attack Proxy By : Hieu Henry  .----.        ")                          

print("------ => This software needs Listings Proxy Or Sock 5 <= ------")

print(">-----O_O-----Edit And Upgrade Version By Henry-----O_O-----<")
...
print "Who Launch List Proxy..."

print "Note: !!! ... !!! You should check the list of Proxy Alive !!! ... !!!"

print "If you want to stop Press Ctrl + C Nhe !!! ;)"
